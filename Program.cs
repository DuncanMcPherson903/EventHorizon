...
.AddEntityFrameworkStores<EventHorizonDbContext>() // Use our DbContext
...
builder.Services.AddAuthentication("Identity.Application")
    ...
    {
      options.Cookie.Name = "EventHorizonAuth";
...
{
  // Add a policy for Users and Admin (Admin or User)
  options.AddPolicy("EventHorizonUserBase", policy =>
...
app.MapGet("/", () => "EventHorizon API is running!");
